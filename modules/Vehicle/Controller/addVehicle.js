const  vehicleModel =require('../../../DB/models/Vehicle')
 ...
 module.exports = async(req,res)=>{
    const {brand,model,color,year,pricePerDay,transmissionType,VehicleRate,Car_Seat,airbag,seatbelts
    ...
    const vehicleData= await vehicleModel.insertMany({brand,model,color,year,pricePerDay,imageURL:req.files,transmissionType,Car_Seat,VehicleRate,airbag,seatbelts
        ,ABS,sunroof,Parking_Sensors,Radio,Navigation_System,Bluetooth,Remote_Start,AC,Music_Player
        ,Extra_Tyre,Charger,Fire_Extinguisher,First_Aid_Kit,CC,
